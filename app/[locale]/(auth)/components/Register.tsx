...
const Register = () => {
  ...
  const handleChange = (e: ChangeEvent<HTMLInputElement>) => {
    ...
    // Use empty array as a default value if files is null
  ...
  return (
    <main className="w-full h-screen flex flex-col items-center justify-center bg-white dark:bg-gray-800 sm:px-4">
      <div className="w-full space-y-6  sm:max-w-md">
        ...
        <div className="bg-gray-50 backdrop-blur-3xl dark:bg-gray-900 shadow p-4 py-6 rounded m-2 space-y-8 sm:p-6 sm:rounded-lg">
          <div className="grid grid-cols-3 gap-x-3">
            <button className="flex items-center justify-center py-2.5 border border-black dark:border-white rounded-lg  duration-150 ">
              <svg
                className="w-5 h-5"
                viewBox="0 0 48 48"
                fill="none"
            ...
            <button className="flex items-center justify-center py-2.5 border border-black dark:border-white rounded-lg hover:bg-gray-50 duration-150 active:bg-gray-100">
              <svg
                className="w-5 h-5"
                viewBox="0 0 48 48"
                fill="none"
            ...
            <button className="flex items-center justify-center text-white  py-2.5 border border-black dark:border-white dark:bg-gray-200 rounded-lg  duration-150 ">
              <svg
                className="w-5 h-5"
                viewBox="0 0 48 48"
                fill="none"
          ...
          <div className="relative">
            ...
            <p className="inline-block w-fit text-sm mt-[-2px] bg-gray-50 dark:bg-gray-900 px-2 absolute -top-2 inset-x-0 mx-auto">
              Or continue with
            </p>
          </div>
          <form onSubmit={onSubmit} className="space-y-5">
            <div>
              ...
              {data.pic && (
                <div className="mt-2 h-20 w-20 block mx-auto rounded-full ring-2 ring-violet-500">
                  <Image
              ...
              <div
                ...
                className="flexCenter p-6 border rounded m-2 cursor-pointer"
              >
                <p className=" text-gray-800 dark:text-white text-xs">
                  Select profile picture includes ***(.jpg|.png|.jpeg)
                </p>
              </div>
              <input
                ref={fileRef}
                ...
                type="file"
                accept="image/*"
                className="w-full hidden mt-2 px-3 py-2 text-gray-500 bg-transparent outline-none border focus:border-indigo-600 shadow-sm rounded-lg"
              />
            </div>
            <div>
              ...
              <input
                ...
                required
                className="w-full mt-2 px-3 py-2 text-gray-500 bg-transparent focus:bg-transparent outline-none border border-black dark:border-white focus:border-indigo-600 shadow-sm rounded-lg"
              />
            </div>
            <div>
            ...
            <div>
              ...
              <input
                ...
                required
                className="w-full mt-2 px-3 py-2 text-gray-200 bg-transparent border-black dark:border-white focus:bg-transparent outline-none border focus:border-indigo-600 shadow-sm rounded-lg"
              />
            </div>
            <button
              disabled={mutation.isPending}
              className="w-full px-4 py-2   font-medium bg-indigo-600 hover:bg-indigo-500 active:bg-indigo-600 rounded-lg duration-150"
            >
