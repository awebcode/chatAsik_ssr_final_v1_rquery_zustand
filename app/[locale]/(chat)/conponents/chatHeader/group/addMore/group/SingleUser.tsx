import { useRemoveFromGroup } from "@/app/[locale]/(chat)/conponents/mutations/chatMutations";
...
const SingleUser = ({ user }: { user: Tuser }) => {
  ...
  return (
    ...
    >
      ...
      <span className="cursor-pointer p-2" onClick={() => {
        removeSelectedUser(user._id);
        removeFromGroup.mutateAsync({chatId:selectedChat?.chatId as any,userId:user._id})}}>
