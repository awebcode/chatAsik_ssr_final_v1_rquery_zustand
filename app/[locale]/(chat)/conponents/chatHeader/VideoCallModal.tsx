...
const VideoCallModal = ({ openVideoCall, setOpenVideoCall, isUserOnline }: any) => {
  ...
  return (
    <div
      className={`z-50 fixed max-w-md w-full p-10 left-1/2 top-10 md:top-[100px] transform -translate-x-1/2 -translate-y-1/2 bg-gray-800 rounded-md shadow-lg transition-transform duration-200 ring-2 ring-blue-500 ${
        openVideoCall
    ...
    >
      <div className="flexCenter flex-col gap-6 mb-8">
        {localStream ? (
          ...
          <h1 className="text-lg md:text-xl ">Call to {selectedChat?.username}!</h1>
        )}
