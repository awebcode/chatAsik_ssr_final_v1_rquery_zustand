...
import UserCard from "../leftsearchDrawer/UserCard";
const LeftSide = () => {
  ...
  return (
    <div className="w-[360px] h-screen bg-white overflow-y-scroll">
      <input
        ...
        className="shadow-lg w-full bg-violet-100 ring ring-violet-400  text-sm py-3 px-3 rounded-md  outline-none border-1 border-yellow-500 hover:border-yellow-500 transition-all duration-300"
      />
