    ...
    <div className="">
      ...
      <ClientWrap>
        ...
        <div className="flex w-screen overflow-hidden">
          {/* <LeftSide /> */}
          <div
            className={`basis-[100%] md:basis-[40%]   h-full min-h-[95vh] w-full rounded-md border-2 m-4 py-4 border-blue-800 hover:border-violet-700 transition-all duration-500 ${
